...
class Window(QWidget):
    ...
    '''
    def on_connect_btn_clicked(self):
        # Combine unique and single shot connection
        flags = Qt.ConnectionType(0x80 | 0x100)
        #flags = Qt.ConnectionType.SingleShotConnection
        print(bool(self.button.clicked.connect(self.on_clicked, flags)))
        # uh-oh
        #print(bool(self.button.clicked.connect(self.on_clicked, 999999)))        
        self.update_label()
    '''
