import sys
from PySide6.QtCore import QObject, Slot, Signal, QThread, QMetaObject, Qt, SLOT, QGenericArgument, Q_ARG
...
class Worker(QObject):
    ...
    def process(self):
        ...
        QMetaObject.invokeMethod(
            self.bank_account,  # QObject
            "withdraw",    # Slot name as string
            Qt.ConnectionType.QueuedConnection,
            Q_ARG(int, self.amount))
        self.finished.emit()
