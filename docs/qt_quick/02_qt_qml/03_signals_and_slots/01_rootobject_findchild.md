...
```qml
{% include src/qtquickexamples/02_qt_qml/02_signals_and_slots/01_rootobject_findchild.qml %}
```
...
```python
{% include src/qtquickexamples/02_qt_qml/02_signals_and_slots/01_rootobject_findchild.py %}
```
